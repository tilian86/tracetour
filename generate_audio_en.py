...
STATIONS = [
    # 0 - Castle Hohentübingen (Puzzle)
    {
        ...
        "story": (
            ...
            "and fled — not down the broad Burgsteige, but through a secret shortcut: a narrow "
            "alley with steep stone steps between the houses, emerging at number three on the "
            "Muenzgasse. These winding stairways are typical of Tuebingen's old town, where "
        ...
        "fact": (
            "Deep in the castle cellar stands a giant: the oldest surviving giant wine barrel in "
            "the world, officially listed in the Guinness Book of Records since twenty nineteen. "
            "The oaks were felled between fifteen forty-six and fifteen fifty in the Schoenbuch "
            "forest. Almost seven meters long, nearly five meters high, around eighty-five thousand "
            "liters of volume. Today a protected bat colony inhabits the cellar — in summer, there "
            "is absolute quiet: no fireworks, no loud music, no lights on the facades. In winter, "
            "from November to March, the barrel can be visited on guided tours.\n\n"
            "Right here, in the former castle kitchen, one of the most important discoveries in "
            "the history of science took place in eighteen sixty-nine: Friedrich Miescher isolated "
            "nuclein for the first time — the substance we now know as DNA. His source material? "
            "Pus-soaked bandages from a nearby surgical clinic.\n\n"
            "In the northeast tower, an astronomical observatory was established in seventeen "
            "fifty-two. From eighteen fourteen onward, Professor Bohnenberger built his own "
            "observatory there and made the tower the cartographic center of Wuerttemberg — the "
            "origin point of all state coordinates. He also developed an early form of the "
            "gyroscope here.\n\n"
            "The Alte Kulturen museum preserves finds from caves of the Swabian Jura: "
            "forty-thousand-year-old ivory figurines — mammoths, wild horses, lions — the oldest "
    ...
    # 1 - Student Prison (Anecdote)
    {
        ...
        "anecdote": (
            ...
            "university prison where Tuebingen students have been locked up since the sixteenth "
            "century. One of the oldest surviving university prisons in Germany. The university held its own "
    ...
    # 2 - Old Assembly Hall (Puzzle)
    {
        ...
        "fact": (
            "The University of Tuebingen is one of the oldest continuously operating universities "
            "in the German-speaking world. Eberhard im Bart founded it in fourteen seventy-seven "
            "with about fifteen professors and around three hundred students. Two of its most "
            "famous alumni: Philipp Melanchthon, who earned his Master's degree here at just "
            "seventeen — and Johannes Kepler, who clashed fiercely with the faculty over his "
            "conviction that the Earth revolves around the Sun.\n\n"
            "Right next to the Alte Aula, from sixteen sixty-three to eighteen oh four, stood "
            "the Hortus Medicus — the university's botanical garden. Here, in sixteen ninety-four, "
            "the botanist Rudolf Jakob Camerarius proved the sexuality of plants through experiments "
            "with castor and corn plants — a milestone in biology. Today, a parking lot occupies "
            "this site.\n\n"
    ...
    # 4 - Stiftskirche (Puzzle)
    {
        ...
        "story": (
            ...
            "The tower holds a secret: it leans about eight centimeters to the northwest. "
            "The cause is a forgotten air-raid shelter from World War Two, running beneath the "
            "southwest facade — built by forced laborers for the police and Gestapo office on "
            "the Muenzgasse. After the war it was forgotten, until massive cracks appeared in "
            "the early nineteen sixties. The shelter was filled with concrete and the church "
            "underwent major restoration between nineteen sixty-two and sixty-five.\n\n"
            "Nine bells hang in the tower — the oldest, the Dominica from fourteen eleven, "
            "weighs three thousand three hundred kilograms and has thundered over Tuebingen "
            "for more than six hundred years. The newest date from nineteen sixty-three."
        ),
        "diary": (
    ...
    # 5 - Holzmarkt & St. George's Fountain (Anecdote)
    {
        ...
        "anecdote": (
            ...
            "Look around: from the fountain you can spot the dragon slayer twice — once on the "
            "fountain and once as a stone relief on the Stiftskirche wall facing the Holzmarkt. "
            "But the two scenes differ: the wall relief includes a person who is missing from "
            "the fountain. Can you find her?\n\n"
    ...
    # 6 - Town Hall & Astronomical Clock (Puzzle)
    {
        ...
        "fact": (
            ...
            "Stoeffler — a masterpiece that calculates moon phases, zodiac signs, and eclipses. "
            "The dragon hand marks the lunar nodes and predicts solar and lunar eclipses. "
            "Stoeffler took his work so seriously that from fifteen twenty-two to fifteen thirty "
            "he lived with his students in the Zur Krone inn directly "
            "opposite the town hall with his students — just so he could observe and recalibrate "
            "the mechanism in any weather.\n\n"
            "His most famous blunder: he predicted a great flood for February fifteen twenty-four. "
            "All of Europe panicked, people built arks. It rained a little. Yet Stoeffler was a "
            "highly respected scholar — his proposals for calendar reform anticipated parts of "
            "the later Gregorian reform. He died in fifteen thirty-one of the plague, not a flood.\n\n"
            "The Cafe Ranitzky on the square looks like old half-timbering — but it is entirely "
            "a modern reconstruction. The original Cafe Pfuderer burned down in the seventies "
    ...
    # 7 - City Museum in the Kornhaus (Anecdote)
    {
        ...
        "anecdote": (
            ...
            "Also worth seeing: the exhibition on Lotte Reiniger, pioneer of silhouette "
            "animation. What many don't know: Her nineteen twenty-six film 'The Adventures of "
            ...
            "eighties renovation, cement-based mortar was used, which actually destroys timber "
            "framing. A Tuebingen master carpenter remarked: 'More damage was done here than "
            "in the last hundred years of wind and weather.'\n\n"
            "Curious story: In two thousand two, it was discovered that a museum employee had "
            "stolen one hundred thirteen objects. One hundred three were recovered.\n\n"
