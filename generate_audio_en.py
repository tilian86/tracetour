...
STATIONS = [
    ...
    # 4 - Stiftskirche (Puzzle)
    {
        ...
        "story": (
            ...
            "The tower holds a secret: it leans five to eight centimeters to the west. Not "
            "because of age — but because excavation work between nineteen sixty-two and nineteen "
            "sixty-four disturbed the ground and caused cracks running through the entire south "
            "facade.\n\n"
            "Seven bells from six centuries hang in the tower — the oldest from around thirteen "
            "ten, the newest from nineteen sixty-three. Together they form a complete Dorian scale. "
            "The most famous: the Dominica from fourteen eleven, weighing three thousand three "
            "hundred kilograms, thundering over Tuebingen for more than six hundred years."
        ),
        "diary": (
    ...
    # 6 - Town Hall & Astronomical Clock (Puzzle)
    {
        ...
        "fact": (
            ...
            "Stoeffler took his work so seriously that he moved into the Zur Krone inn directly "
