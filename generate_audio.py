...
STATIONS = [
    # 0 - Schloss Hohentuebingen (Raetsel)
    {
        ...
        "story": (
            ...
            "seinen Mantel und floh – nicht über die breite Burgsteige, sondern durch einen "
            "engen Schleichweg: eine schmale Gasse mit steilen Steintreppen zwischen den Häusern, "
            "die bei Hausnummer drei in der Münzgasse herauskommt. Diese verwinkelte Passage ist "
        ...
        "fact": (
            "Tief im Schlosskeller steht ein Gigant: das älteste erhaltene Riesenweinfass der "
            "Welt, seit zweitausendneunzehn offiziell im Guinness-Buch der Rekorde. Die Eichen "
            "dafür wurden zwischen fünfzehnhundertsechsundvierzig und fünfzehnhundertfünfzig im "
            "Schönbuch gefällt. Fast sieben Meter lang, knapp fünf Meter hoch, rund "
            "fünfundachtzigtausend Liter Fassungsvermögen. Heute bewohnt eine geschützte "
            "Fledermauskolonie den Keller – im Sommer herrscht absolutes Ruhegebot: kein "
            "Feuerwerk, keine laute Musik, kein Licht an den Fassaden. Im Winter, von November "
            "bis März, kann man das Fass bei Führungen besichtigen.\n\n"
            "Genau hier, in der ehemaligen Schlossküche, gelang achtzehnhundertneunundsechzig "
            "eine der wichtigsten Entdeckungen der Wissenschaftsgeschichte: Friedrich Miescher "
            "isolierte erstmals Nuklein – die Substanz, die wir heute als DNA kennen. Sein "
            "Ausgangsmaterial? Eitergetränkte Verbände aus einer nahen chirurgischen Klinik.\n\n"
            "Im Nordostturm wurde siebzehnhundertzweiundfünfzig ein astronomisches Observatorium "
            "eingerichtet. Ab achtzehnhundertvierzehn baute Professor Bohnenberger dort sein "
            "eigenes Observatorium aus und machte den Turm zum kartographischen Mittelpunkt "
            "Württembergs – der Nullpunkt aller Landeskoordinaten. Nebenbei entwickelte er hier "
            "eine frühe Form des Gyroskops.\n\n"
            "Das Museum Alte Kulturen bewahrt Funde aus Höhlen der Schwäbischen Alb: "
            "vierzigtausend Jahre alte Elfenbeinfiguren – Mammuts, Wildpferde, Löwen – "
    ...
    # 1 - Studentenkarzer (Anekdote)
    {
        ...
        "anecdote": (
            ...
            "das Universitätsgefängnis, in das Tübinger Studenten seit dem sechzehnten Jahrhundert "
            "gesperrt wurden. Einer der ältesten erhaltenen Uni-Karzer Deutschlands. Die Universität "
    ...
    # 2 - Alte Aula (Raetsel)
    {
        ...
        "fact": (
            "Die Universität Tübingen gehört zu den ältesten durchgängig bestehenden Universitäten "
            "im deutschsprachigen Raum. Eberhard im Bart gründete sie vierzehnhundertsiebenundsiebzig "
            "mit etwa fünfzehn Professoren und rund dreihundert Studenten. Zwei ihrer berühmtesten "
            "Absolventen: Philipp Melanchthon, der hier mit nur siebzehn Jahren den Magister machte – "
            "und Johannes Kepler, der wegen seiner Überzeugung, die Erde drehe sich um die Sonne, "
            "in heftige Konflikte mit der Fakultät geriet.\n\n"
            "Direkt neben der Alten Aula lag von sechzehnhundertdreiundsechzig bis achtzehnhundertvier "
            "der Hortus Medicus – der botanische Garten der Universität. Hier geschah "
            "sechzehnhundertvierundneunzig Wissenschaftsgeschichte: Der Botaniker Rudolf Jakob "
            "Camerarius bewies durch Experimente an Rizinus- und Maispflanzen erstmals die Sexualität "
            "der Pflanzen – ein Meilenstein der Biologie. Heute ist an dieser Stelle ein Parkplatz.\n\n"
    ...
    # 4 - Stiftskirche (Raetsel)
    {
        ...
        "story": (
            ...
            "Der Turm hat ein Geheimnis: Er neigt sich etwa acht Zentimeter nach Nordwesten. "
            "Die Ursache ist ein vergessener Luftschutzkeller aus dem Zweiten Weltkrieg, der unter "
            "der Südwestfassade verläuft – gebaut von Zwangsarbeitern für die Polizei- und "
            "Gestapodienststelle in der Münzgasse. Nach dem Krieg geriet er in Vergessenheit, bis "
            "Anfang der sechziger Jahre massive Risse in der Fassade auftraten. Der Keller wurde "
            "mit Beton verfüllt und die Kirche zwischen neunzehnhundertzweiundsechzig und "
            "neunzehnhundertfünfundsechzig grundlegend saniert.\n\n"
            "Im Turm hängen neun Glocken – die älteste, die Dominica von vierzehnhundertelf, "
            "wiegt dreitausenddreihundert Kilogramm und dröhnt seit über sechshundert Jahren "
            "über Tübingen. Die jüngsten stammen von neunzehnhundertdreiundsechzig."
        ),
        "diary": (
    ...
    # 5 - Holzmarkt & Georgsbrunnen (Anekdote)
    {
        ...
        "anecdote": (
            ...
            "Schau dich um: Vom Georgsbrunnen aus siehst du den Drachentöter gleich zweimal – "
            "einmal auf dem Brunnen und einmal als Steinrelief an der Kirchenwand der Stiftskirche, "
            "Richtung Holzmarkt. Aber die beiden Szenen unterscheiden sich: Im Relief an der Wand "
            "ist eine Person dabei, die auf dem Brunnen fehlt. Findest du sie?\n\n"
    ...
    # 6 - Rathaus & Astronomische Uhr (Raetsel)
    {
        ...
        "fact": (
            ...
            "entworfen – ein Meisterwerk, das Mondphasen, Tierkreiszeichen und Finsternisse "
            "berechnet. Der Drachenzeiger markiert die Mondknoten und sagt Sonnen- und "
            "Mondfinsternisse voraus. Stöffler nahm die Sache so ernst, dass er von "
            "fünfzehnhundertzweiundzwanzig bis fünfzehnhundertdreißig mit seinen Studenten "
            "in die Herberge 'Zur Krone' direkt gegenüber dem Rathaus zog – heute Kronenstraße "
            "elf, Café Ranitzky. Nur so konnte er die Mechanik bei jedem Wetter beobachten "
            "und nachjustieren.\n\n"
            "Seine berühmteste Fehlprognose: Für Februar fünfzehnhundertvierundzwanzig sagte er "
            "eine Sintflut voraus. Ganz Europa geriet in Panik, Menschen bauten Archen. Es regnete "
            "ein bisschen. Dabei war Stöffler ein hochseriöser Gelehrter – seine Vorschläge zur "
            "Kalenderreform nahmen Teile der späteren Gregorianischen Reform vorweg. Er starb "
            "fünfzehnhunderteinunddreißig an der Pest, nicht an einer Flut.\n\n"
            "Das Café Ranitzky am Platz sieht aus wie altes Fachwerk – ist aber komplett ein "
            "Neubau. Das Original, das Café Pfuderer, brannte in den Siebzigern ab und wurde "
            "in gleicher Gestalt neu errichtet.\n\n"
    ...
    # 7 - Stadtmuseum im Kornhaus (Anekdote)
    {
        ...
        "anecdote": (
            ...
            "Außerdem sehenswert: die Ausstellung zu Lotte Reiniger, der Pionierin des "
            "Silhouetten-Animationsfilms. Was viele nicht wissen: Ihr Werk 'Die Abenteuer des "
            "Prinzen Achmed' von neunzehnhundertsechsundzwanzig ist der erste abendfüllende "
            "Animationsfilm der Weltgeschichte – Jahre vor Walt Disneys 'Schneewittchen'. Die "
            ...
            "bei der Sanierung in den Achtzigern zementhaltiger Mörtel verwendet, der eigentlich "
            "Fachwerkhölzer zerstört. Ein Tübinger Zimmermeister: 'Hier wurde mehr kaputt gemacht "
            "als in den letzten hundert Jahren durch Wind und Wetter.'\n\n"
            ...
            "Der Eintritt ist seit April zweitausendachtzehn frei. Sonntags um fünfzehn Uhr gibt es "
            "eine Führung – fünf Euro für Erwachsene, Kinder kostenlos.\n\n"
...
SPECIAL_AUDIO = {
    ...
    "formula": {
        ...
        "text": (
            ...
            "deiner letzten Station entfernt. Ein Dichter, der in einer Zeit des Umbruchs "
            "nach Hoffnung suchte.\n\n"
            "Heinrich kannte diese Verse. Und er verstand etwas, das die Mächtigen nicht "
            "verstehen wollten: Die wahre Formel war nie eine Waffe. Sie war ein Versprechen.\n\n"
            "Wo Wissen unterdrückt wird, wächst der Mut, es zu teilen. Wo Angst regiert, "
            "wachsen Menschen über sich hinaus. Wo alles verloren scheint, entsteht etwas Neues.\n\n"
            "Das gilt achtzehnhundertdrei. Das gilt achtzehnhundertneunundsechzig. "
            "Und das gilt heute.\n\n"
            "Wir leben in einer Zeit, in der die Nachrichten uns täglich mit Krisen überhäufen – "
            "Klimawandel, Konflikte, Unsicherheit. Es ist leicht, die Hoffnung zu verlieren. "
            "Aber Hölderlins Erkenntnis ist aktueller denn je: Gerade weil Gefahr da ist, "
            "wächst auch das Rettende.\n\n"
            "Junge Forschende entwickeln Lösungen für die Energiewende. Menschen setzen sich "
            "für Frieden ein. Städte wie Tübingen zeigen, dass Wandel möglich ist – "
            "mit Mut, Wissen und Zusammenhalt.\n\n"
            "Heinrich hat seine Formel nicht für Könige versteckt. Er hat sie für Menschen "
            "wie dich versteckt – Menschen, die neugierig genug sind, Geheimnisse zu suchen. "
            "Die mutig genug sind, die Wahrheit weiterzutragen. Und die verstehen: "
            "Wissen gehört nicht den Mächtigen. Wissen gehört der Welt.\n\n"
            "Das ist Heinrichs Vermächtnis. Und jetzt ist es auch deins."
        ),
    },
    "thanks": {
