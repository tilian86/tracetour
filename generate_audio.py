...
STATIONS = [
    ...
    # 4 - Stiftskirche (Raetsel)
    {
        ...
        "story": (
            ...
            "Der Turm hat ein Geheimnis: Er neigt sich fünf bis acht Zentimeter nach Westen. "
            "Nicht wegen seines Alters – sondern wegen Freilegungsarbeiten zwischen "
            "neunzehnhundertzweiundsechzig und neunzehnhundertvierundsechzig, die den Baugrund "
            "erschütterten und durchgehende Risse in der Südfassade verursachten.\n\n"
            "Im Turm hängen sieben Glocken aus sechs Jahrhunderten – die ältesten stammen von "
            "etwa dreizehnhundertzehn, die jüngste von neunzehnhundertdreiundsechzig. Zusammen bilden "
            "sie eine vollständige dorische Tonleiter. Die berühmteste: die Dominica von "
            "vierzehnhundertelf, dreitausenddreihundert Kilogramm schwer, die seit über sechshundert "
            "Jahren über Tübingen dröhnt."
        ),
        "diary": (
    ...
    # 6 - Rathaus & Astronomische Uhr (Raetsel)
    {
        ...
        "fact": (
            ...
            "Mondfinsternisse voraus. Stöffler nahm die Sache so ernst, dass er mit seinen "
            "Studenten in die Herberge 'Zur Krone' direkt gegenüber dem Rathaus zog – nur so "
            "konnte er die Mechanik bei jedem Wetter beobachten und nachjustieren.\n\n"
